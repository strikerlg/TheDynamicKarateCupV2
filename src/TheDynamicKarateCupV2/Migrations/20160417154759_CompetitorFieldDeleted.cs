...
{
    public partial class CompetitorFieldDeleted : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "CompetitorFirstNameName", table: "Competitor");
